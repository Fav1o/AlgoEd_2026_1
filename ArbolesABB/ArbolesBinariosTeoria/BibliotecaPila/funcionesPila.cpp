...
struct NodoArbolBinarioBusqueda * cima(const struct Pila & pilaTAD) {
...
void apilar(struct Pila & pilaTAD, struct NodoArbolBinarioBusqueda *elemento) {
...
struct NodoArbolBinarioBusqueda * desapilar(struct Pila & pilaTAD) {
...
void destruir(struct Pila & pilaTAD) {
    ...
    while (not esPilaVacia(pilaTAD)) {
        struct NodoArbolBinarioBusqueda *sale = desapilar(pilaTAD);
    }
